...
Last updated to:
- Alacritty Terminal v0.19.0 upstream
- Alacritty (base) 0.12.1
...
Rendering with nannou requires a patched version of nannou that exposes a couple of private structures.
Pending merge: https://github.com/nannou-org/nannou/pull/895
...
Where possible I change references to iChannel0 to the `base` color, which contains the hexagons, nannou polar clock, etc.
